<template>
  <div class="absolute bottom-0 z-40 w-screen h-10 text-center whitespace-nowrap overflow-x-scroll overflow-y-hidden bg-main-dark text-main-red border-t border-gray-400">
    <div
